    ...
    return (
        ...
        <div id='shop' className='relative md:h-full md:bg-contain bg-center  bg-no-repeat flex flex-col gap-10 pt-20  lg:py-10 lg:pt-32 '>
            ...
            <div className='p-2 text-2xl sm:text-[2rem] md:text-[2.5rem] lg:text-[3.5rem] group font-bold text-center md:w-10/12 mx-auto flex items-center justify-center flex-wrap gap-x-5 lg:gap-y-2'>
                    ...
                    <img alt='homeDecoration' src='https://store.figma.com/cdn/shop/t/12/assets/word-symbol-hourglass.static.svg?v=133626873782927219541705692308' />
                    <p className=' group-hover:opacity-50  duration-300'>OF</p>
                    <p>LAYERS</p>  
                    <img alt='homeDecoration' src='https://store.figma.com/cdn/shop/t/12/assets/word-symbol-zag.static.svg?v=102718930007740203771705692308' />
                    <p className=' group-hover:opacity-50  duration-300'>AND</p> 
                    <img alt='homeDecoration' src='https://store.figma.com/cdn/shop/t/12/assets/word-symbol-dots.static.svg?v=39142388321885661271705692308'/> 
                    <p>COMPONENTS</p>  
                    <img alt='homeDecoration' src='https://store.figma.com/cdn/shop/t/12/assets/word-symbol-sun.static.svg?v=163357932534391307201705692308' />
                    <p className=' group-hover:opacity-50  duration-300'>FOR</p> 
                    <p className=' group-hover:opacity-50  duration-300'>YOU</p>  
                    <img alt='homeDecoration' src='https://store.figma.com/cdn/shop/t/12/assets/word-symbol-comet.static.svg?v=16892712658856357451705692308'/>
                    <p className=' group-hover:opacity-50  duration-300'>AND</p>  
                    <img alt='homeDecoration' src='https://store.figma.com/cdn/shop/t/12/assets/word-symbol-snake.static.svg?v=34100567131936571961705692308' />
                    <p className=' group-hover:opacity-50  duration-300'>YOUR</p>  
                    <img alt='homeDecoration' src='https://store.figma.com/cdn/shop/t/12/assets/word-symbol-tri.static.svg?v=32742515804419710851705692308' />
            ...
            <div className=' relative'>
                    ...
                    <div className='hidden md:block'>
                        <img alt='homeDecoration' className=' object-cover w-full h-full' src='https://store.figma.com/cdn/shop/files/desktop_2400x.png?v=1702333702)' />
                    </div>
